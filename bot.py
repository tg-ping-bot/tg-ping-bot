...
if not BOT_TOKEN:
    print(" ОШИБКА: Не найден токен BOT_TOKEN в настройках Render!")
    exit(1)
...
# Функция удаления (не блокирует бота)
